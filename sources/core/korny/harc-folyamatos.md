...
> Megj.: Ez a fejezet egy olyan harcrendszert ismertet, ami inkább hasonlít egy akciófilm eseménydús jeleneteihez, de több számolást igényel. Amennyiben egy egyszerűbb, gyorsabb harcrendszert szeretnétek, a következő fejezetben az egyszerűbb, fázisos harcrendszert is megtaláljátok.
...
>  **Reakció ellenpróba:** támadó **felismerés/veszély** (vagy **orvtámadás**) *vs.* ellenfelek **felismerés/veszély**
...
A harci cselekedetek közé kizárólag a támadás, és a védekezés (hárítás)
tartozik.  Míg a támadás befejeződő, a védekező kitartható cselekedet.

Támadáskor támadási értéket (**TÉ**) kell dobni:

> **TÉ** = harci képzettség \+ **TH** \+ támadási módosító \+ *1d* \+ **ERŐ** bónusz - **MT**

ahol

- **TÉ** = támadási érték
- harci képzettség = a harci szakértelem és a megfelelő specializációk összege
- **TH** = fegyver támadási hatékonyság
- támadási módosító = ld. az alábbi táblázatban, a mesélő ítéli meg
- **MT** = megterheltség
...
Ilyenkor a támadás ellen leginkább hárítással lehet védekezni.  Ilyenkor
védekezési értéket (**VÉ**) kell dobni:

> **VÉ** = harci képzettség \+ **VH** \+ védekezési módosító \+ *1d* \+ **ÜGY** bónusz - **MT**

ahol

- **VÉ** = védekezési érték
- **VH** = fegyver védekezési hatékonyság
- védekezési módosító = ld. az alábbi táblázat
...
> **Hátrányban lévő VH-ja:** **VH** - 3 × méretkülönbség
...
A távolsági fegyverek ellen nem lehet hárítással védekezni: ellenük csak a
páncél segíthet.  Ám el is kell találni az ellenfelet.  Így a **VÉ**
nagyban függ a távolságtól (ld. az alábbi táblázat).  Függ továbbá a
célpont méretétől is, valamint attól, hogy mennyire sikerült elbújnia.

> **VÉ** = távolsági módosítók \+ védekezési módosítók - **ERŐ** bónusz - **MT**
...
> **sebzés** = **méret** × *1d* (\+ sebzésmódosító) (\+ támadó **ERŐ** bónusz) - páncél **SF**
...
**MT**.  Az, hogy egy tömbbe hány kifáradás pont fér be, az a karakter **EGS**
bónuszától függ:

> **kifáradás tömb mérete** = 6 \+ **EGS** bónusz + **ERŐ** bónusz
