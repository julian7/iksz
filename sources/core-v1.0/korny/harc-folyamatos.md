...
**Important:** Reakció ellenpróba: támadó **felismerés/veszély** (vagy **orvtámadás**) *vs.*
...
**Important:** **CSI** = sebességmódosító + **MT** - **ÜGY**\ bónusz
...
**Important:** **TÉ** = harci képzettség + **TH** + támadási módosító + *1d* +
**ERŐ** bónusz - **MT**
...
**Important:** Riposzt **TS**: Fegyver **TS** - Fegyver **VS**
...
**Important:** **VÉ** = harci képzettség + **VH** + védekezési módosító + *1d*
+ **ÜGY** bónusz - **MT**

ahol

| **VH** | = | fegyver védekezési hatékonyság | védekezési módosító | = | ld. táblázat |
| --- | --- | --- | --- | --- | --- |
...
**Important:** Hátrányban lévő **VH**-ja: **VH** - 3 x méretkülönbség
...
nagyban függ a távolságtól (ld. táblázat). Függ továbbá a
célpont méretétől is, valamint attól, hogy mennyire sikerült elbújnia.

**Important:** **VÉ** = távolsági módosítók + védekezési módosítók - **ERŐ** bónusz -
**MT**
...
Példa sebességmódosítókat a .~táblázatban
találsz.
...
**Important:** sebzés = **méret** x *1d* (+ sebzésmódosító) (+ támadó **ERŐ**\ bónusz)
- páncél **SF**
...
**Important:** kifáradás tömb mérete = 6 + **ÉGS**\ bónusz + **ERŐ**\ bónusz
